  ...
  return (
    <div className="bg-white sm:rounded-md h-full hover:no-underline flex flex-row flex-wrap md:flex-no-wrap px-2">
      <a
        ...
        className="m-2 p-4 rounded-lg inline-block w-full hover:no-underline border border-blue-600 "
      >
        <div className="flex items-center justify-between">
          <div className=" text-xl leading-8 font-medium text-blue-600">
            Twitter
          </div>
      ...
      >
        <div className="flex items-center justify-between text-orange-600">
          <div className=" text-xl leading-8 font-medium text-orange-600">
            Instagram
          </div>
          <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
            <path
        ...
        <div className="text-sm text-orange-600 mt-2">
          Check out the lastest images NYCMakesPPE...
        </div>
      </a>
      <a
        href="https://www.instagram.com/nycmakesppe/?utm_source=ig_embed&utm_campaign=loading"
      ...
      >
        ...
        <div className="text-sm text-gray-600 mt-2">
          Colaborate on design, guides and more...
        </div>
      </a>
    </div>
  )
